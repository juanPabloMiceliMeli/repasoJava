...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Prenda> lNike = new ArrayList<>(List.of(pNike1, pNike2, pNike3));
        ...
        List<Prenda> lAdidas = new ArrayList<>(List.of(pAdidas1, pAdidas2, pAdidas3));
        ...
        List<Prenda> lTopper = new ArrayList<>(List.of(pTopper1, pTopper2, pTopper3));
